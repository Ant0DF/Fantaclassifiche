  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mb-4 text-center z-10 transition-transform hover:-translate-y-2 cursor-default">
        <div
          className={`p-3 rounded-full mb-2 bg-gray-800/80 backdrop-blur-sm border-2 ${
            isFirst
        ...
        <span className="font-bold text-white text-sm md:text-base truncate w-full px-1">
          {name}
        </span>
      ...
      {/* Blocco Podio */}
      <div
        className={`w-full ${heightClass} ${colorClass} rounded-t-lg border-t-4 shadow-lg flex items-start justify-center pt-4 relative overflow-hidden group`}
      >
    ...
    <div className="mb-16 animate-fade-in">
      ...
      <div className="bg-gray-800/40 backdrop-blur-md rounded-3xl p-6 md:p-10 border border-gray-700/50 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex items-end justify-center gap-2 md:gap-6 pt-12 md:pt-20">
          <PodiumStep
            rank={podiumOrder[0].rank}
            name={podiumOrder[0].name}
            score={podiumOrder[0].score}
            delay={400}
          />
          <PodiumStep
            rank={podiumOrder[1].rank}
            name={podiumOrder[1].name}
            score={podiumOrder[1].score}
            delay={100}
          />
          <PodiumStep
            rank={podiumOrder[2].rank}
            name={podiumOrder[2].name}
            score={podiumOrder[2].score}
            delay={700}
          />
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-gray-100 font-sans selection:bg-indigo-500/30">
      ...
      <header className="relative pt-20 pb-16 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="inline-flex items-center justify-center p-3 bg-gray-800/50 rounded-full mb-6 border border-gray-700 animate-float">
            ...
            <span className="text-sm font-semibold tracking-widest uppercase text-gray-300 pr-2">
              Hall of Fame
            </span>
          </div>
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-12">
            Scopri i vincitori storici delle leghe di Fantasanremo e
            Fantaeurovision. Chi ha scalato le vette del punteggio?
          </p>
      ...
      <footer className="border-t border-gray-800 bg-gray-900/50 text-center py-8">
        <p className="text-gray-500 flex items-center justify-center gap-2">
          Prossima Competizione: Eurovision Song Contest 2026 (12-14-16 maggio
          2026) <Star className="w-4 h-4 text-yellow-600" />
        </p>
      </footer>
    </div>
  );
